...
<div class="card p-4" style="width: 25rem;">
  ...
  <div class="card-footer">
   <a href="Login.jsp" class="btn btn-outline-danger">Go to</a>
  </div>
</div>

<div class="card p-4" style="width: 25rem;">
  <h2 class="info">PREMIUM</h2><hr/>
  ...
  <div class="card-footer">
   <a href="Payment.jsp" class="btn btn-outline-success">Go to</a>
  </div>
</div>
</div>
</div>
